...
## Online Parity Contract V1

`full_market_online_parity_v1` is the only allowed core input contract for a
...
groups are intentionally catalogue-only for V1, not registered model inputs.
