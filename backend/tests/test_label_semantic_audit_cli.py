...
class LabelSemanticAuditCliTests(unittest.TestCase):
    def test_help_exposes_research_asset_inputs_only(self):
        script = Path(__file__).resolve().parents[1] / "scripts" / "run_label_semantic_audit.py"
