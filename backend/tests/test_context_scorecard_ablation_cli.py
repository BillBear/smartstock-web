...
class ContextScorecardAblationCliTests(unittest.TestCase):
    def test_help_exposes_only_research_asset_inputs(self):
        script = Path(__file__).resolve().parents[1] / "scripts" / "run_context_scorecard_ablation.py"
        ...
        self.assertIn("--bootstrap-iterations", completed.stdout)
