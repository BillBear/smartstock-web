...
class RegimeScorecardCliTests(unittest.TestCase):
    def test_help_exposes_only_research_inputs_and_output_root(self):
        script = Path(__file__).resolve().parents[1] / "scripts" / "run_regime_scorecard_oof.py"
