#!/usr/bin/env python3
"""Run development-only market-regime-conditioned scorecard OOF research."""
...
from app.evaluation.full_market_ml.regime_scorecard_runner import run_regime_conditioned_scorecard_oof
...
def main() -> int:
    ...
    report = run_regime_conditioned_scorecard_oof(
