#!/usr/bin/env python3
"""Run fixed, development-only H1 industry-relative feature evidence."""
...
from app.evaluation.full_market_ml.shsz_h1_feature_evidence import run_shsz_h1_feature_evidence  # noqa: E402
