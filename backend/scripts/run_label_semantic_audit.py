#!/usr/bin/env python3
"""Run a development-only semantic audit of registered ten-session labels."""
...
from app.evaluation.full_market_ml.label_semantic_audit_runner import run_label_semantic_audit
...
def main() -> int:
    ...
    report = run_label_semantic_audit(
