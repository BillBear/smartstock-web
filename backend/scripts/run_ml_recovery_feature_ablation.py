#!/usr/bin/env python3
"""Run the fixed development-only ML recovery H1 experiment."""
...
from app.evaluation.ml_recovery_feature_ablation import run_h1_momentum_trend_experiment
...
def main() -> int:
    ...
    parser.add_argument("--code-commit", required=True, help="Git commit that defines this H1 run")
    args = parser.parse_args()

    report = run_h1_momentum_trend_experiment(
